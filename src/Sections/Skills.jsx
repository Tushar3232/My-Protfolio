...
const Skills = () => {
  ...
  const renderSkillCard = (skill) => (
    <div
      key={skill.name}
      className="bg-black p-6 m-4 rounded-2xl shadow-lg hover:shadow-cyan-400/50 hover:-translate-y-2 transition-all duration-300 flex flex-col items-center min-w-[120px] border-2 border-cyan-400"
    >
      <img
        src={skill.img}
        alt={skill.name}
